...
export function QuickActions() {
  return (
    <section className="select-none font-sans space-y-3">
      ...
      <Link
        href="/owner/cars/add"
        className="group relative flex items-center justify-between rounded-lg border border-accent md:border-line/40 bg-accent md:bg-card p-3.5 sm:p-4 text-inverse md:text-ink transition-all duration-200 hover:border-accent/50 md:hover:bg-accent/5 active:scale-[0.98]"
      >
        <div className="flex items-center gap-3">
          <div className="flex h-8 w-8 sm:h-9 sm:w-9 items-center justify-center rounded-md bg-white/20 md:bg-accent text-white md:text-inverse transition-transform duration-200 group-hover:scale-105">
