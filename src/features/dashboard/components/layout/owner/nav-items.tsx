...
import { LayoutDashboard, Layers, IndianRupee, Car, CalendarCheck, Users, Settings, type LucideIcon } from "lucide-react";
...
export const ownerNavItems: NavItem[] = [
  ...
  { label: "Sales", href: "/owner/sales", icon: IndianRupee, mobile: true },
